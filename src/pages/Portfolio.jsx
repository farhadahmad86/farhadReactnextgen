...
const Portfolio = () => {
  ...
  return (
    <>
      <PageTitle
        id="pad3"
        title="Crafting Brands That Make a Lasting Impression"
        backgroundImage="assets/img/LandingPages/portfolio.webp"
        subtitle="Portfolio"
        para="At NextGen Studios, we turn ideas into powerful brands. With over 150 global clients, our creative solutions make a lasting impact. Let’s build your brand story together."
      />
      <section id="portfolio" className="portfolio section">
        ...
        >
          <h2>Portfoilo</h2>
          {/* <p>
          At NextGen Studio, we turn ideas into powerful brands. With over 150 global clients, our creative solutions make a lasting impact. Let’s build your brand story together.
          </p> */}
        </div>
        ...
        <div className="container" style={{ width: "80%" }}>
          ...
          >
            ...
            >
              ...
              <li
                onClick={() => handleFilterChange("filter-product")}
              ...
              <li
                onClick={() => handleFilterChange("filter-animation")}
                className={filter === "filter-animation" ? "filter-active" : ""}
              >
                Animation
              </li>
            </ul>
